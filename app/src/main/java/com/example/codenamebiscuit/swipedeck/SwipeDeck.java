...
import com.example.codenamebiscuit.swipedeck.Utility.Deck;
import com.example.codenamebiscuit.swipedeck.Utility.SwipeCallback;
...
public class SwipeDeck extends FrameLayout {
    ...
    public SwipeDeck(final Context context, AttributeSet attrs) {
        ...
        deck = (Deck<CardContainer>) new Deck<>(new Deck.DeckEventListener() {
            @Override
